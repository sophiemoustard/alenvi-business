<template>
  <div class="row bg-gradient">
    ...
    <section class="text-justify layout-padding">
      ...
      <p>Le vieillissement de la population doit être l’occasion de créer des dizaines de milliers d’emplois valorisants et qualifiés, grâce à la technologie et à un modèle d’organisation innovant. C’est l’ambition qui nous anime chez Alenvi. Si vous la partagez, rejoignez-nous ou faites le nous savoir !</p>
    </section>
  </div>
</template>
