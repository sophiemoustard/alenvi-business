<template>
  <q-page>
    <section id="presentation-picture" class="q-mb-xl">
      ...
      <q-btn v-if="$q.platform.is.desktop" class="main-button-call-to-action gt-md" icon="call" color="primary" size="lg"><a href="tel:+33183761607">Appeler au 01 83 76 16 07</a></q-btn>
    ...
    <section v-if="!$q.platform.is.mobile" id="call-button" class="lt-lg a-pa-xl q-mb-xl row justify-center items-center">
      <q-btn icon="call" color="primary" size="lg"><a href="tel:+33183761607">Appeler au 01 83 76 16 07</a></q-btn>
    </section>
